...
export const initialProducts = [
  ...
  {
    id: 'prod-f-shirt-1',
    name: 'Women’s Pure Silk Button-Down Collared Blouse',
    slug: 'womens-pure-silk-button-down-blouse',
    sku: 'TOP-SLK-001-IVR',
    category: 'clothes',
    categoryName: 'Clothes',
    gender: 'female',
    ...
    description: 'Sophisticated 19mm crepe de chine silk button-down shirt. Clean covered placket, French seams, and polished mother-of-pearl buttons.',
    specifications: {
      'Material': '100% Mulberry Silk',
      'Fit': 'Relaxed Workwear Blouse',
      'Gender': 'Women'
    },
    variants: [
      { id: 'vfs-1', name: 'Ivory Pearl / S', color: '#fdf4dc', size: 'S', price: 3299, stock: 15, sku: 'TOP-SLK-IVR-S' }
    ],
    tags: ['Silk Blouse', 'Office Wear', 'Women Shirts']
  },
  {
    id: 'prod-f-shirt-2',
    name: 'Women’s Relaxed Linen Boyfriend Shirt',
    ...
    description: 'Slouchy relaxed oversized linen shirt with dropped shoulders and curved high-low shirttail hem. Perfect tucked into denim or worn over swimwear.',
    specifications: {
  ...
  {
    id: 'prod-f-shirt-3',
    name: 'Women’s Ribbed Seamless Contour Knit Crop Top',
    slug: 'womens-ribbed-seamless-contour-knit-crop-top',
    sku: 'TOP-CRP-003-TAU',
    category: 'clothes',
    categoryName: 'Clothes',
    gender: 'female',
    ...
    description: 'Double-layered seamless ribbed modal crop top. Offers light compressive support, square neckline, and thick stay-put shoulder straps.',
    specifications: {
      'Fabric': '92% Seamless Nylon, 8% Spandex',
      'Gender': 'Women'
    },
    variants: [
      { id: 'vfs-3', name: 'Warm Taupe / S', color: '#d6d3d1', size: 'S', price: 1199, stock: 35, sku: 'TOP-CRP-TAU-S' }
    ],
    tags: ['Crop Top', 'Ribbed Knit', 'Women Shirts']
  },
