...
export const initialOrders = [
  ...
  {
    id: 'ord-102',
    orderNumber: 'CRT-784292',
    customerName: 'Ananya Reddy',
    customerEmail: 'ananya.reddy@example.com',
    customerPhone: '+91 98490 12345',
    createdAt: '2026-09-02T10:15:00Z',
    status: 'confirmed',
    verificationCode: 'VFY-619284',
    paymentStatus: 'paid',
    paymentGateway: 'razorpay',
    paymentId: 'pay_Xk8mQ19sWp02b',
    trackingNumber: 'DELHIVERY-99418274',
    subtotal: 3999,
    discountAmount: 400,
    couponCode: 'CARTLY10',
    shippingCost: 0,
    ...
    shippingAddress: {
      ...
      street: 'B-201, Jubilee Hills Road No. 36',
      city: 'Hyderabad',
      state: 'Telangana',
      postalCode: '500033',
    ...
    items: [
      {
        id: 'oi-2',
        productId: 'prod-w-dress-1',
        productName: 'Handwoven Mulberry Silk Midi Dress',
        brand: 'Aura Silk',
        category: 'clothes',
        subcategory: 'dresses',
        size: 'S',
        ...
        unitPrice: 3999,
        quantity: 1,
        variantName: 'Cerulean Blue / Small'
      }
    ]
  }
];
