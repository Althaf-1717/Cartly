...
const STORAGE_KEYS = {
  PRODUCTS: 'cartly_products_v3',
  CATEGORIES: 'cartly_categories_v3',
  BRANDS: 'cartly_brands_v3',
  COUPONS: 'cartly_coupons_v3',
  BANNERS: 'cartly_banners_v3',
  ORDERS: 'cartly_orders_v3',
  REVIEWS: 'cartly_reviews_v3',
  AUDIT_LOGS: 'cartly_audit_logs_v3',
};
...
function getLocalData(key, fallback) {
  if (typeof window === 'undefined') {
    const memoryKey = key.replace('cartly_', '').replace('_v3', '');
