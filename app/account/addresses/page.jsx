  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#061e14] text-slate-900 dark:text-emerald-50 transition-colors duration-200">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 py-10 w-full space-y-6">
        {toastMsg && (
          <div className="p-3 bg-emerald-600 text-white text-xs font-bold rounded-xl flex items-center justify-between">
            <span>{toastMsg}</span>
        ...
        <div className="flex items-center justify-between">
          <Link
            href="/account"
            className="text-xs text-slate-500 dark:text-emerald-300/70 hover:text-emerald-600 flex items-center gap-1.5 font-bold"
          >
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-emerald-300/70 mt-1">Manage delivery locations for swift checkout</p>
        </div>

        {isAdding ? (
          /* Address Form matching Image 1 */
          <div className="bg-white dark:bg-[#09261a] border border-slate-200 dark:border-emerald-800 rounded-2xl p-6 shadow-xs max-w-xl">
            ...
            <form onSubmit={handleSave} className="space-y-3.5 text-xs">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-emerald-950 border border-slate-200 dark:border-emerald-800 rounded-xl text-slate-900 dark:text-white"
                >
              ...
              <label className="flex items-center gap-2 pt-1 cursor-pointer">
                ...
                />
                <span className="text-slate-700 dark:text-emerald-200 font-bold text-xs">
              ...
              <div className="pt-2 flex gap-3">
                ...
                <button
                  ...
                  className="px-4 py-3 bg-slate-100 dark:bg-emerald-950 border border-slate-200 dark:border-emerald-800 text-slate-700 dark:text-emerald-200 font-bold rounded-xl"
                >
                  Cancel
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {addresses.map((addr) => (
              <div
                key={addr.id}
                className={`p-5 bg-white dark:bg-[#09261a] border rounded-2xl relative space-y-2 shadow-xs transition ${
                  addr.isDefault
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {addr.isDefault && (
                    <span className="px-2.5 py-0.5 bg-emerald-600 text-white text-[10px] font-bold rounded-md uppercase">
                      Default Destination
                    </span>
                  )}
                </div>
                ...
                <p className="text-xs text-slate-500 dark:text-emerald-400/60 font-mono pt-1">
                  Phone: {addr.phone}
                </p>

                <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-emerald-900/60 text-xs">
                  {!addr.isDefault ? (
                    <button
