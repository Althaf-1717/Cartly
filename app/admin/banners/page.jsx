      ...
      <main className="p-6 sm:p-8 space-y-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {banners.map((b) => (
            <div
              key={b.id}
              className="bg-[#111111] border border-slate-800/80 rounded-2xl overflow-hidden shadow-md"
            >
              ...
              <div className="p-5 text-xs text-slate-300 space-y-2">
                ...
                <div className="flex justify-between items-center pt-2 border-t border-slate-800">
                  <span className="text-[11px] text-orange-400 font-mono">Link: {b.ctaLink}</span>
