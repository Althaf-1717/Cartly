    ...
    <AnimatePresence>
      {message && (
        <motion.div
          ...
          className="fixed top-20 right-4 sm:right-6 z-[9990] flex items-center gap-3 bg-white dark:bg-[#111111] border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white px-4 py-3 rounded-2xl shadow-xl backdrop-blur-md"
        >
          ...
          <div className="pr-1">
            ...
            <span className="text-[10px] text-slate-400 dark:text-slate-400/60 font-medium">Cartly Instant Sync</span>
          </div>
        </motion.div>
      )}
    </AnimatePresence>
